...
async function runTsCompile(localTs, compilerOptions, srcPathList) {
    // Must do it. becuase the value in department.json might be different from the inner representation.
...
function readTSConfig() {
    // department.json may have comment string, which is invalid if
    // using `require('department.json'). So we use a loose parser.
    let filePath = nodePath.resolve(ecDir, 'department.json');
